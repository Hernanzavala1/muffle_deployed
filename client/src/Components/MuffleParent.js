    ...
    render() {
        return (
            <div className="container-fluid" style={{ minWidth: "1100px" }}>
                ...
                <Route path={['/profileScreen', '/network', '/player', '/publicPlayer', '/createPlaylist', '/home', '/library', '/edit']} render={props => <Music_Player {...props} ref={this.musicPlayer} currentPlaylist={this.state.currentPlaylist} currentSong={this.state.currentSong} />}></Route>
            </div>
